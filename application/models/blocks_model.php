    ...
    <div class="col-lg-12">
        <div class = "content-block">
            ...
            <div class="content-radio-group">
                ...
                <div class = "content-radio">
                    <input class="ajax-button" data-block-name="block_seller_info" data-name="bs_owned_car" type="radio" name="vendor_is_owner_car" value="own_car">
                    <span class = "content-input-align">Продавец является собственником ТС</span>
                </div>

                <div class = "content-radio">
                    <input class="ajax-button" data-block-name="block_seller_info" data-name="bs_not_owned_car" type="radio" name="vendor_is_owner_car" value="not_own_car">
                ...
                <div class="col-lg-6">
                    <div class = "content-radio">
                        <div class = "content-input">
                            ...
                            <span class = "content-input-align">ЛАнтиблокировочная тормозная система</span>
                        </div>
...
<div class="row" id="block_car_state">
    <div class="col-lg-12">
        <div class = "content-block">
...
<div class="row" id="block_maintenance">
    <div class="col-lg-12">
        <div class = "content-block">
...
<div class="row" id="block_features">
    <div class="col-lg-12">
...
<div class="row" id="block_payment_date">
    <div class="col-lg-12">
        <div class = "content-block">
...
<div class="row" id="block_accessories">
    <div class="col-lg-12">
        <div class = "content-block">
    ...
    <div class="col-lg-12">
        <div class = "content-block">
            ...
            <div class = "content-radio">
                ...
                <div class = "content-input">
                    <input id="accessories_other" type="radio" name="accessories">
                    <span class = "content-input-align">Иное:</span>
                </div>
            </div>
        </div>
...
<div class="row" id="block_penalty">
    <div class="col-lg-12">
        <div class = "content-block">
